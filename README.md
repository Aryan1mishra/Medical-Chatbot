...
An AI-powered Medical Question Answering Chatbot built using Large Language Models (LLMs) and Retrieval-Augmented Generation (RAG).This project focuses on the core AI/ML pipeline, enabling intelligent, context-aware responses to medical queries.
